...
\hypersetup{unicode, colorlinks, linkcolor=, citecolor=, urlcolor=linkcolor}
% -- siunitx
\sisetup{
	locale=DE,
...
% Notwendig, damit das \micro (µ) die richtige Schriftart hat und die
% Serifenschrift für siunitx verwendet wird
