...
\lstset{
	...
	moretexcs={
		f, latex, Alpha,
		part, chapter, subsection, subsubsection, paragraph, subparagraph, color, text, mathbb, mathcal, tableofcontents, includegraphics, cref, crefrange, autocite, footcite, printbibliography,
